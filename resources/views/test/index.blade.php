...
<p><strong>PLEASE NOTE: I cannot provide any support or guidance beyond this README. If this code helps you that's great but I have no plans to develop Nestable beyond this demo (it's not a final product and has limited functionality). I cannot reply to any requests for help.</strong></p>
    ...
    <div class="cf nestable-lists">
        <div class="dd" id="nestable">
            <ol class="dd-list">
                @foreach($menus as $d)
                <li class="dd-item" data-menu_id="{{ $d->menu_id }}">
                    ...
                    <ol class="dd-list">
                        ...
                        <li class="dd-item" data-menu_id="{{ $c->menu_id }}"><div class="dd-handle">-&nbsp;&nbsp;{{ $c->name }}</div></li>
                        @endforeach
                    </ol>
                </li>
                @endforeach
    ...
    <form action="{{ route('kirim') }}" method="POST">
        ...
        <textarea  id="ayam" name="test" required cols="550" rows="10"></textarea>
        ...
        <div class="dd" id="nestable3">
            <ol class="dd-list">
                <li class="dd-item dd3-item" data-id="1">
                    <div class="dd-handle dd3-handle">Drag</div><div class="dd3-content">1</div>
                </li>
