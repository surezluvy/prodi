                ...
                <div class="breadcrumbs-inner">
                    <div class="container">
                        <div class="breadcrumbs-text">
                            <h1 class="breadcrumbs-title">{{ $post->menu->name }}</h1>
                            <div class="back-nav">
                                <ul>
                                    <li><a href="{{ route('index') }}">Home</a></li>
                                    <li>{{ $post->menu->name }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="inner-blog">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <div class="button__sec">
                                            <a href="{{ route('post-detail', $p->post_id) }}" class="blog-btn">Read More <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                                            ...
                                            <span>
                                                <a href="javascript:void(0)"><i aria-hidden="true" class="social_facebook"></i></a>
                                                <a href="javascript:void(0)"><i aria-hidden="true" class="social_twitter"></i></a>
                                                <a href="javascript:void(0)"><i aria-hidden="true" class="social_linkedin"></i></a>
                                            </span>
                                            </div>
                                        </div>
                                    </div>
