    ...
    <div class="row second-chart-list third-news-update">
      <div class="col-xl-4 col-lg-12 xl-50 morning-sec box-col-12">
        <div class="card profile-greeting">
          <div class="card-body pb-0">
            ...
            <div class="cartoon"><img class="img-fluid" src="{{ asset('assets/admin/images/dashboard/cartoon.png') }}" alt=""></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 xl-50 news box-col-6">
        <div class="card">
          ...
          <div class="card-body p-0">
            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/admin/images/dashboard/update/1.jpg') }}" alt="">
              <div class="media-body">
            ...
            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/admin/images/dashboard/update/2.jpg') }}" alt="">
              <div class="media-body">
            ...
            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/admin/images/dashboard/update/3.jpg') }}" alt="">
              <div class="media-body">
              ...
              <div class="card-body pt-0">
                <div class="appointment-table table-responsive">
                  <table class="table table-bordernone">
                    <tbody>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle mb-3" src="{{ asset('assets/admin/images/appointment/app-ent.jpg') }}" alt="Image description">
                      ...
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('assets/admin/images/appointment/app-ent.jpg') }}" alt="Image description">
                          <div class="status-circle bg-primary"></div>
                        </td>
            ...
            <div class="media">
              <div class="media-body">
                <div class="d-flex mb-3">
                  <div class="inner-img"><img class="img-fluid" src="{{ asset('assets/admin/images/notification/1.jpg') }}" alt="Product-1"></div>
                  <div class="inner-img"><img class="img-fluid" src="{{ asset('assets/admin/images/notification/2.jpg') }}" alt="Product-2"></div>
            ...
            <div class="chat">
              <div class="media left-side-chat">
                <div class="media-body d-flex">
                  <div class="img-profile"> <img class="img-fluid" src="{{ asset('assets/admin/images/user.jpg') }}" alt="Profile"></div>
                  <div class="main-chat">
