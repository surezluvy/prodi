                ...
                <div class="card-body pb-0">
                    <div class="media">
                        ...
                        <div class="badge-groups">
                            <div class="badge f-10"><i class="me-1" data-feather="clock"></i><span id="txt"></span>
                            </div>
                        </div>
                    </div>
                    <div class="cartoon"><img class="img-fluid"
                            src="{{ asset('assets/admin/images/dashboard/cartoon.png') }}" alt=""></div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                        ...
                        <div class="card-header-right-icon">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a
                                        class="dropdown-item" href="javascript:void(0)">Today</a><a
                                        class="dropdown-item" href="javascript:void(0)">Tomorrow</a><a
                                        class="dropdown-item" href="javascript:void(0)">Yesterday</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                            src="{{ asset('assets/admin/images/dashboard/update/1.jpg') }}" alt="">
                        <div class="media-body">
                    ...
                    <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                            src="{{ asset('assets/admin/images/dashboard/update/2.jpg') }}" alt="">
                        <div class="media-body">
                    ...
                    <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                            src="{{ asset('assets/admin/images/dashboard/update/3.jpg') }}" alt="">
                        <div class="media-body">
                ...
                <div class="card-footer">
                    <div class="bottom-btn"><a href="javascript:void(0)">See all</a></div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="dropdownMenuButton"><a class="dropdown-item"
                                                href="javascript:void(0)">Today</a><a class="dropdown-item"
                                                href="javascript:void(0)">Tomorrow</a><a class="dropdown-item"
                                                href="javascript:void(0)">Yesterday</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle mb-3"
                                                    src="{{ asset('assets/admin/images/appointment/app-ent.jpg') }}"
                ...
                <div class="card-body pt-0">
                    <div class="media">
                        <div class="media-body">
                            ...
                            <h6>Updated Product<span class="dot-notification"></span></h6><span>Quisque a consequat ante
                                sit amet magna...</span>
                        </div>
                    </div>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="d-flex mb-3">
                                <div class="inner-img"><img class="img-fluid"
                                        src="{{ asset('assets/admin/images/notification/1.jpg') }}" alt="Product-1">
                                </div>
                                <div class="inner-img"><img class="img-fluid"
                                        src="{{ asset('assets/admin/images/notification/2.jpg') }}" alt="Product-2">
                                </div>
                    ...
                    <div class="header-top">
                        ...
                        <div class="card-header-right-icon">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a
                                        class="dropdown-item" href="javascript:void(0)">Year</a><a class="dropdown-item"
                                        href="javascript:void(0)">Month</a><a class="dropdown-item"
                                        href="javascript:void(0)">Day</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="media left-side-chat">
                            <div class="media-body d-flex">
                                <div class="img-profile"> <img class="img-fluid"
                                        src="{{ asset('assets/admin/images/user.jpg') }}" alt="Profile"></div>
                                <div class="main-chat">
