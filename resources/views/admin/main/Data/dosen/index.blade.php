                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" aria-hidden="true" data-bs-toggle="modal" data-bs-target="#create"
                            ...
                            data-original-title="btn btn-pill btn-success" wire:click="clear()">+ Tambah dosen</button>
                                    ...
                                    <form wire:submit.prevent="addDosen">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="nidn" class="form-control" type="text">
                                                @error('nidn') <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label" for="recipient-name">Riwayat Pendidikan:
                                                    <small class="text-secondary">*Pisahkan dengan koma</small></label>
                                                <input wire:model="education" class="form-control" type="text">
                                                @error('education') <span
                                                    class="error text-danger">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label" for="recipient-name">Bidang keahlian:
                                                    <small class="text-secondary">*Pisahkan dengan koma</small></label>
                                                <input wire:model="expertise" class="form-control" type="text">
                                                @error('expertise') <span
                                                    class="error text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click.prevent="edit({{ $dosen->lecturer_id }})" type="button" aria-hidden="true" data-bs-toggle="modal"
                                                data-bs-target="#edit-{{ $dosen->lecturer_id }}"
                                                class="btn btn-primary"><i class="fa fa-pencil"
                                                    aria-hidden="true"></i></button>
                                            <button type="button" aria-hidden="true" data-bs-toggle="modal"
                                                data-bs-target="#delete-{{ $dosen->lecturer_id }}"
                                                class="btn btn-danger"><i class="fa fa-trash-o"
                                                    aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <div wire:ignore class="modal fade" id="edit-{{ $dosen->lecturer_id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form wire:submit.prevent="editDosen({{ $dosen->lecturer_id }})"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input autofocus class="form-control" type="text"
                                                                wire:model="name" value="{{ $dosen->name }}" required>
                                                            <div class="invalid-feedback">Nama dosen wajib diisi</div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label"
                                                                for="recipient-name">Kode:</label>
                                                            <input class="form-control" type="text" wire:model="code"
                                                                value="{{ $dosen->code }}" required>
                                                            <div class="invalid-feedback">Kode wajib diisi</div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label"
                                                                for="recipient-name">NIDN:</label>
                                                            <input class="form-control" type="text" wire:model="nidn"
                                                                value="{{ $dosen->nidn }}" required>
                                                            <div class="invalid-feedback">NIDN wajib diisi</div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="recipient-name">Riwayat
                                                                Pendidikan: <small class="text-secondary">*Pisahkan
                                                                    dengan koma</small></label>
                                                            <input class="form-control" type="text" wire:model="education"
                                                                value="{{ $dosen->education }}" required>
                                                            <div class="invalid-feedback">Riwayat Pendidikan wajib diisi
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="recipient-name">Bidang
                                                                keahlian: <small class="text-secondary">*Pisahkan dengan
                                                                    koma</small></label>
                                                            <input class="form-control" type="text" wire:model="expertise"
                                                                value="{{ $dosen->expertise }}" required>
                                                            <div class="invalid-feedback">Bidang keahlian wajib diisi
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                    ...
                                    <div class="modal fade" id="delete-{{ $dosen->lecturer_id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label class="col-form-label" for="recipient-name">Apakah anda
                                                            yakin akan menghapus menu
                                                            <strong>{{ $dosen->name }}</strong>?</label>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" type="button"
                                                        data-bs-dismiss="modal">Tutup</button>
                                                    <button wire:click="deleteDosen({{ $dosen->lecturer_id }})"
